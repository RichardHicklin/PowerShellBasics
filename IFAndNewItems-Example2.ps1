...
# $PathToDirectory = "c:\ps-test\scripts" <- We set this in code. we then test the path to see if the direcotrey is present
...
# The exampke shows a simple If statement
